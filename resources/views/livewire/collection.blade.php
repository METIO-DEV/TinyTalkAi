                    ...
                    <li>
                        ...
                        <div class="flex items-center space-x-1">
                            ...
                            <button
                                ...
                                title="Ajouter un document à cette collection"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <form wire:submit.prevent="createCollection">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-xs text-gray-500 mt-1">
                                Lettres minuscules, chiffres et underscores uniquement (ex: ma_collection_1)
                            </p>
                        ...
                        <div class="flex justify-end space-x-2">
                            ...
                            <button 
                                ...
                                wire:target="createCollection"
                            >
                                <span wire:loading.remove wire:target="createCollection">Créer</span>
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="bg-custom-white dark:bg-custom-light-dark-mode rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full z-10">
                <div class="px-6 py-4">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-medium text-custom-black dark:text-custom-white">
                            Ajouter un document à la collection "{{ $selectedCollection }}"
                        </h3>
                        <button type="button" 
                                x-on:click="closeModal()"
                                class="text-gray-500 hover:text-gray-700">
